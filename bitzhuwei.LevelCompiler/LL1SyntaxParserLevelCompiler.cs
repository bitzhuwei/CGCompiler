...
using bitzhuwei.CompilerBase;
    ...
    public partial class LL1SyntaxParserLevelCompiler : LL1SyntaxParserBase<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
    {
        ...
        /// <summary>
        /// 对 &lt;Level&gt; ::= &quot;level&quot;... 进行分析
        /// <para>&lt;Level&gt; ::= &quot;level&quot; &quot;{&quot; &lt;StepList&gt; &quot;}&quot;;</para>
        /// </summary>
        ...
        /// <summary>
        /// 对 &lt;StepList&gt; ::= &quot;}&quot;... 进行分析
        /// <para>&lt;StepList&gt; ::= null;</para>
        /// </summary>
        private static CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            FuncParsecase_StepList___tail_rightBrace_Leave;
        /// <summary>
        /// 对 &lt;StepList&gt; ::= &quot;step&quot;... 进行分析
        /// <para>&lt;StepList&gt; ::= &lt;Step&gt; &lt;StepList&gt;;</para>
        /// </summary>
        private static CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            FuncParsecase_StepList___tail_stepLeave;
        /// <summary>
        /// 对 &lt;Step&gt; ::= &quot;step&quot;... 进行分析
        /// <para>&lt;Step&gt; ::= &quot;step&quot; &quot;{&quot; &lt;TankList&gt; &quot;}&quot;;</para>
        /// </summary>
        private static CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            FuncParsecase_Step___tail_stepLeave;
        /// <summary>
        /// 对 &lt;TankList&gt; ::= &quot;}&quot;... 进行分析
        ...
        private static readonly EnumVTypeLevelCompiler m_tail_stepLeave = EnumVTypeLevelCompiler.tail_stepLeave;
        ...
        private static readonly EnumVTypeLevelCompiler m_case_StepList = EnumVTypeLevelCompiler.case_StepList;
        private static readonly EnumVTypeLevelCompiler m_case_Step = EnumVTypeLevelCompiler.case_Step;
        ...
        /// </summary>
        public static CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            GetFuncParsecase_StepList___tail_rightBrace_Leave()
        {
            return FuncParsecase_StepList___tail_rightBrace_Leave;
        }
        /// <summary>
        /// 对 &lt;StepList&gt; ::= &quot;step&quot;... 进行分析
        /// <para>&lt;StepList&gt; ::= &lt;Step&gt; &lt;StepList&gt;;</para>
        /// </summary>
        public static CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            GetFuncParsecase_StepList___tail_stepLeave()
        {
            return FuncParsecase_StepList___tail_stepLeave;
        }
        /// <summary>
        /// 对 &lt;Step&gt; ::= &quot;step&quot;... 进行分析
        /// <para>&lt;Step&gt; ::= &quot;step&quot; &quot;{&quot; &lt;TankList&gt; &quot;}&quot;;</para>
        /// </summary>
        public static CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            GetFuncParsecase_Step___tail_stepLeave()
        {
            return FuncParsecase_Step___tail_stepLeave;
        }
        /// <summary>
        /// 对 &lt;TankList&gt; ::= &quot;}&quot;... 进行分析
        /// <para>&lt;TankList&gt; ::= null;</para>
        ...
        /// </summary>
        public static CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            GetFuncParsetail_stepLeave_()
        {
            return FuncParsetail_stepLeave_;
        }
        /// <summary>
        /// 对 叶结点&quot;tank&quot; 进行分析
        /// </summary>
            ...
            Parsecase_Level___tail_levelLeave(SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> result, ISyntaxParser<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> parser)
        {
            ...
            return Derivationcase_Level___tail_levelLeavetail_leftBrace_Leavecase_StepListtail_rightBrace_Leave(result, parser);
        }
        /// <summary>
        /// 对 &lt;StepList&gt; ::= &quot;}&quot;... 进行分析
        /// <para>&lt;StepList&gt; ::= null;</para>
        ...
        /// <returns></returns>
        private static SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            Parsecase_StepList___tail_rightBrace_Leave(SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> result, ISyntaxParser<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> parser)
        {
            // <StepList> ::= null;
            return Derivationcase_StepList___epsilonLeave(result, parser);
        }
        /// <summary>
        /// 对 &lt;StepList&gt; ::= &quot;step&quot;... 进行分析
        /// <para>&lt;StepList&gt; ::= &lt;Step&gt; &lt;StepList&gt;;</para>
        ...
        /// <returns></returns>
        private static SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            Parsecase_StepList___tail_stepLeave(SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> result, ISyntaxParser<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> parser)
        {
            // <StepList> ::= <Step> <StepList>;
            return Derivationcase_StepList___case_Stepcase_StepList(result, parser);
        }
        /// <summary>
        /// 对 &lt;Step&gt; ::= &quot;step&quot;... 进行分析
        /// <para>&lt;Step&gt; ::= &quot;step&quot; &quot;{&quot; &lt;TankList&gt; &quot;}&quot;;</para>
        ...
        /// <returns></returns>
        private static SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            Parsecase_Step___tail_stepLeave(SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> result, ISyntaxParser<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> parser)
        {
            // <Step> ::= "step" "{" <TankList> "}";
            return Derivationcase_Step___tail_stepLeavetail_leftBrace_Leavecase_TankListtail_rightBrace_Leave(result, parser);
        }
        /// <summary>
        /// 对 &lt;TankList&gt; ::= &quot;}&quot;... 进行分析
        /// <para>&lt;TankList&gt; ::= null;</para>
        ...
        /// <returns></returns>
        private static SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            Parsetail_stepLeave_(SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> result, ISyntaxParser<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> parser)
        {
            var parserLevelCompiler = parser as LL1SyntaxParserLevelCompiler;
            result.NodeValue.NodeType = EnumVTypeLevelCompiler.tail_stepLeave;
            result.NodeValue.NodeName = parserLevelCompiler.m_TokenListSource[parserLevelCompiler.m_ptNextToken].Detail;
            result.MappedTotalTokenList = parserLevelCompiler.m_TokenListSource;
            result.MappedTokenStartIndex = parserLevelCompiler.m_ptNextToken;
            parserLevelCompiler.m_ptNextToken++;
        ...
        private static SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            Derivationcase_Level___tail_levelLeavetail_leftBrace_Leavecase_StepListtail_rightBrace_Leave(
        ...
        {//<Level> ::= "level" "{" <StepList> "}";
            ...
            parserLevelCompiler.m_ParserStack.Push(m_case_StepList);
            ...
            var case_StepListTree2 = new SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>();
            case_StepListTree2.MappedTotalTokenList = parserLevelCompiler.m_TokenListSource;
            case_StepListTree2.MappedTokenStartIndex = parserLevelCompiler.m_ptNextToken;
            case_StepListTree2.Parent = result;
            //case_StepListTree2.Value = new ProductionNode(EnumVTypeLevelCompiler.case_StepList);
            result.Children.Add(case_StepListTree2);
        ...
        /// <returns>下一个要扩展的结点</returns>
        private static SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            Derivationcase_StepList___case_Stepcase_StepList(
            SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> result,
            ISyntaxParser<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> parser)
        {//<StepList> ::= <Step> <StepList>;
            var parserLevelCompiler = parser as LL1SyntaxParserLevelCompiler;
            result.NodeValue.NodeType = EnumVTypeLevelCompiler.case_StepList;
            result.NodeValue.NodeName = EnumVTypeLevelCompiler.case_StepList.ToString();
            //result.NodeValue.Position = EnumProductionNodePosition.NonLeave;
            result.MappedTotalTokenList = parserLevelCompiler.m_TokenListSource;
            result.MappedTokenStartIndex = parserLevelCompiler.m_ptNextToken;
            parserLevelCompiler.m_ParserStack.Pop();
            // right-to-left push
            parserLevelCompiler.m_ParserStack.Push(m_case_StepList);
            parserLevelCompiler.m_ParserStack.Push(m_case_Step);
            // generate syntax tree
            var case_StepTree0 = new SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>();
            case_StepTree0.MappedTotalTokenList = parserLevelCompiler.m_TokenListSource;
            case_StepTree0.MappedTokenStartIndex = parserLevelCompiler.m_ptNextToken;
            case_StepTree0.Parent = result;
            //case_StepTree0.Value = new ProductionNode(EnumVTypeLevelCompiler.case_Step);
            result.Children.Add(case_StepTree0);
            var case_StepListTree1 = new SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>();
            case_StepListTree1.MappedTotalTokenList = parserLevelCompiler.m_TokenListSource;
            case_StepListTree1.MappedTokenStartIndex = parserLevelCompiler.m_ptNextToken;
            case_StepListTree1.Parent = result;
            //case_StepListTree1.Value = new ProductionNode(EnumVTypeLevelCompiler.case_StepList);
            result.Children.Add(case_StepListTree1);
            return case_StepTree0;
        }//<StepList> ::= <Step> <StepList>;
        /// <summary>
        /// &lt;StepList&gt; ::= null;
        /// <summary>
        ...
        /// <returns>下一个要扩展的结点</returns>
        private static SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            Derivationcase_StepList___epsilonLeave(
            SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> result,
            ISyntaxParser<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> parser)
        {//<StepList> ::= null;
            var parserLevelCompiler = parser as LL1SyntaxParserLevelCompiler;
        ...
        /// <returns>下一个要扩展的结点</returns>
        private static SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>
            Derivationcase_Step___tail_stepLeavetail_leftBrace_Leavecase_TankListtail_rightBrace_Leave(
            SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> result,
            ISyntaxParser<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler> parser)
        {//<Step> ::= "step" "{" <TankList> "}";
            var parserLevelCompiler = parser as LL1SyntaxParserLevelCompiler;
            result.NodeValue.NodeType = EnumVTypeLevelCompiler.case_Step;
            result.NodeValue.NodeName = EnumVTypeLevelCompiler.case_Step.ToString();
            //result.NodeValue.Position = EnumProductionNodePosition.NonLeave;
            result.MappedTotalTokenList = parserLevelCompiler.m_TokenListSource;
            result.MappedTokenStartIndex = parserLevelCompiler.m_ptNextToken;
            parserLevelCompiler.m_ParserStack.Pop();
            ...
            parserLevelCompiler.m_ParserStack.Push(m_tail_leftBrace_Leave);
            parserLevelCompiler.m_ParserStack.Push(m_tail_stepLeave);
            // generate syntax tree
            var tail_stepLeaveTree0 = new SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>();
            tail_stepLeaveTree0.MappedTotalTokenList = parserLevelCompiler.m_TokenListSource;
            tail_stepLeaveTree0.MappedTokenStartIndex = parserLevelCompiler.m_ptNextToken;
            tail_stepLeaveTree0.Parent = result;
            //tail_stepLeaveTree0.Value = new ProductionNode(EnumVTypeLevelCompiler.tail_stepLeave);
            result.Children.Add(tail_stepLeaveTree0);
            var tail_leftBrace_LeaveTree1 = new SyntaxTree<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>();
            tail_leftBrace_LeaveTree1.MappedTotalTokenList = parserLevelCompiler.m_TokenListSource;
            tail_leftBrace_LeaveTree1.MappedTokenStartIndex = parserLevelCompiler.m_ptNextToken;
            tail_leftBrace_LeaveTree1.Parent = result;
        ...
        private void FillMapCells()
        {
            ...
            m_Map.SetCell(EnumVTypeLevelCompiler.case_StepList, EnumTokenTypeLevelCompiler.token_RightBrace_, FuncParsecase_StepList___tail_rightBrace_Leave);
            m_Map.SetCell(EnumVTypeLevelCompiler.case_StepList, EnumTokenTypeLevelCompiler.token_step, FuncParsecase_StepList___tail_stepLeave);
            m_Map.SetCell(EnumVTypeLevelCompiler.case_Step, EnumTokenTypeLevelCompiler.token_step, FuncParsecase_Step___tail_stepLeave);
            ...
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_levelLeave, EnumTokenTypeLevelCompiler.token_step, FuncParsetail_levelLeave_);
            ...
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_leftBrace_Leave, EnumTokenTypeLevelCompiler.token_step, FuncParsetail_leftBrace_Leave_);
            ...
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_rightBrace_Leave, EnumTokenTypeLevelCompiler.token_step, FuncParsetail_rightBrace_Leave_);
            ...
            m_Map.SetCell(EnumVTypeLevelCompiler.epsilonLeave, EnumTokenTypeLevelCompiler.token_step, FuncParseepsilonLeave_);
            ...
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_stepLeave, EnumTokenTypeLevelCompiler.token_level, FuncParsetail_stepLeave_);
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_stepLeave, EnumTokenTypeLevelCompiler.token_LeftBrace_, FuncParsetail_stepLeave_);
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_stepLeave, EnumTokenTypeLevelCompiler.token_RightBrace_, FuncParsetail_stepLeave_);
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_stepLeave, EnumTokenTypeLevelCompiler.epsilon, FuncParsetail_stepLeave_);
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_stepLeave, EnumTokenTypeLevelCompiler.token_step, FuncParsetail_stepLeave_);
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_stepLeave, EnumTokenTypeLevelCompiler.token_tank, FuncParsetail_stepLeave_);
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_stepLeave, EnumTokenTypeLevelCompiler.number, FuncParsetail_stepLeave_);
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_stepLeave, EnumTokenTypeLevelCompiler.token_startEnd, FuncParsetail_stepLeave_);
            ...
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_tankLeave, EnumTokenTypeLevelCompiler.token_step, FuncParsetail_tankLeave_);
            ...
            m_Map.SetCell(EnumVTypeLevelCompiler.numberLeave, EnumTokenTypeLevelCompiler.token_step, FuncParsenumberLeave_);
            ...
            m_Map.SetCell(EnumVTypeLevelCompiler.tail_startEndLeave, EnumTokenTypeLevelCompiler.token_step, FuncParsetail_startEndLeave_);
        ...
        private void InitFunc()
        {
            ...
            FuncParsecase_StepList___tail_rightBrace_Leave = 
                new CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>(Parsecase_StepList___tail_rightBrace_Leave);
            FuncParsecase_StepList___tail_stepLeave = 
                new CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>(Parsecase_StepList___tail_stepLeave);
            FuncParsecase_Step___tail_stepLeave = 
                new CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>(Parsecase_Step___tail_stepLeave);
            FuncParsecase_TankList___tail_rightBrace_Leave = 
            ...
            FuncParsetail_stepLeave_ = 
                new CandidateFunction<EnumTokenTypeLevelCompiler, EnumVTypeLevelCompiler, TreeNodeValueLevelCompiler>(Parsetail_stepLeave_);
            FuncParsetail_tankLeave_ = 
        ...
        private void SetMapLinesAndColumns()
        {
            ...
            m_Map.SetLine(1, EnumVTypeLevelCompiler.case_StepList);
            m_Map.SetLine(2, EnumVTypeLevelCompiler.case_Step);
            m_Map.SetLine(3, EnumVTypeLevelCompiler.case_TankList);
            m_Map.SetLine(4, EnumVTypeLevelCompiler.case_Tank);
            m_Map.SetLine(5, EnumVTypeLevelCompiler.case_TankPrefab);
            m_Map.SetLine(6, EnumVTypeLevelCompiler.case_BornPoint);
            
            m_Map.SetLine(7, EnumVTypeLevelCompiler.tail_levelLeave);
            m_Map.SetLine(8, EnumVTypeLevelCompiler.tail_leftBrace_Leave);
            m_Map.SetLine(9, EnumVTypeLevelCompiler.tail_rightBrace_Leave);
            m_Map.SetLine(10, EnumVTypeLevelCompiler.epsilonLeave);
            m_Map.SetLine(11, EnumVTypeLevelCompiler.tail_stepLeave);
            m_Map.SetLine(12, EnumVTypeLevelCompiler.tail_tankLeave);
            m_Map.SetLine(13, EnumVTypeLevelCompiler.numberLeave);
            m_Map.SetLine(14, EnumVTypeLevelCompiler.tail_startEndLeave);
            ...
            m_Map.SetColumn(4, EnumTokenTypeLevelCompiler.token_step);
            m_Map.SetColumn(5, EnumTokenTypeLevelCompiler.token_tank);
