...
namespace bitzhuwei.CompilerBase
{
        ...
        where TTreeNodeValue : class, ICloneable, new()
    {
        ...
        public LL1SyntaxParserMap(int line, int column)
        {
            ...
            this.m_ParserMap = new Dictionary<string, CandidateFunction<TEnumTokenType, TEnumVType, TTreeNodeValue>>();
        ...
        private Dictionary<string, CandidateFunction<TEnumTokenType, TEnumVType, TTreeNodeValue>> m_ParserMap = null;
